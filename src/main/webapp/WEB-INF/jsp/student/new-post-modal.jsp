...
<div id="new-post-modal" class="fixed inset-0 z-[60] bg-black/50 backdrop-blur-sm flex items-center justify-center hidden">
    ...
    <div class="bg-card w-full max-w-lg p-6 rounded-xl shadow-2xl border border-primary/20">
        ...
        <%-- Form Content: Added method and action --%>
        <form action="${pageContext.request.contextPath}/student/forum/create" method="POST" class="mt-6 space-y-4">
            ...
            <div class="space-y-3">
                <label class="flex items-center space-x-2 cursor-pointer">
                    <%-- Note: 'value="true"' ensures Spring receives 'true' when checked --%>
            ...
            <%-- Submit Button --%>
            <div class="pt-2">
                <button type="submit" class="w-full bg-primary text-primary-foreground py-2.5 rounded-xl font-semibold text-lg shadow-lg hover:bg-primary/90 transition-all active:scale-[0.98]">
